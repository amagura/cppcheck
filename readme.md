...
This is a fork of CppCheck, and should be mostly compatible with upstream; the primary difference between the two is that while Cppcheck seems to follow trends, cchk does not.
